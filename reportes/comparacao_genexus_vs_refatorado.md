...
**Agente:** Agente_04_Comparador_GeneXus_vs_Refatorado  
**Data:** 19/02/2025  
...
| RegistroAvisoLog | BC | Entidade | — | ⚠️ Parcial | registroavisolog.json (modelo pode existir) |
...
| **RegistroAvisoLog** | Modelo/tabela pode existir; fluxo de registro de avisos incompleto |
...
2. **RegistroAvisoLog:** Criar modelo e tabela se inexistentes; documentar fluxo de VerificaSeAvisaUsuarioApontamento para implementação futura.
